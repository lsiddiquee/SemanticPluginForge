...
/// <summary>
/// Extension methods for adding plugins from OpenAPI and OpenAI sources with metadata to the kernel's plugin collection.
/// </summary>
public static class AddPluginExtensions
{
    ...
    /// <summary>
    /// Creates a plugin from an OpenAI metadata file, updates its metadata, and adds it to the kernel's plugin collection.
    /// </summary>
    /// <param name="kernel">The <see cref="Kernel"/> containing services, plugins, and other state for use throughout the operation.</param>
    /// <param name="pluginName">The name of the plugin.</param>
    /// <param name="filePath">The file path to the OpenAI metadata file.</param>
    /// <param name="executionParameters">Optional execution parameters for the plugin.</param>
    /// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
    /// <returns>A task representing the asynchronous operation. The task result contains the added <see cref="KernelPlugin"/>.</returns>
    ...
    /// <summary>
    /// Creates a plugin from an OpenAI metadata URI, updates its metadata, and adds it to the kernel's plugin collection.
    /// </summary>
    /// <param name="kernel">The <see cref="Kernel"/> containing services, plugins, and other state for use throughout the operation.</param>
    /// <param name="pluginName">The name of the plugin.</param>
    /// <param name="uri">The URI to the OpenAI metadata.</param>
    /// <param name="executionParameters">Optional execution parameters for the plugin.</param>
    /// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
    /// <returns>A task representing the asynchronous operation. The task result contains the added <see cref="KernelPlugin"/>.</returns>
    ...
    /// <summary>
    /// Creates a plugin from an OpenAI metadata stream, updates its metadata, and adds it to the kernel's plugin collection.
    /// </summary>
    /// <param name="kernel">The <see cref="Kernel"/> containing services, plugins, and other state for use throughout the operation.</param>
    /// <param name="pluginName">The name of the plugin.</param>
    /// <param name="stream">The stream representing the OpenAI metadata.</param>
    /// <param name="executionParameters">Optional execution parameters for the plugin.</param>
    /// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
    /// <returns>A task representing the asynchronous operation. The task result contains the added <see cref="KernelPlugin"/>.</returns>
